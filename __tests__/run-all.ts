...
import { runTests as runCalendarTests } from "./unit/calendar.test.js";
...
import { runTests as runOcsTests } from "./unit/ocs.test.js";
import { runTests as runExcludeTests } from "./unit/exclude.test.js";
...
const testSuites: TestSuite[] = [
  ...
  { name: "Calendar", category: "unit", run: runCalendarTests },
  ...
  { name: "OCS", category: "unit", run: runOcsTests },
  { name: "Exclude", category: "unit", run: runExcludeTests },
